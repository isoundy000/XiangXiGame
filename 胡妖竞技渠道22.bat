...
mkdir 正式包\res\achannel\22
xcopy res\achannel\22 正式包\res\achannel\22 /e
...
mkdir 渠道22
xcopy 正式包 渠道22 /e
mkdir 正式包\src\version\22
mkdir 渠道22\src\version\22
copy ".\src\version\22\*" ".\渠道22\src\version\22\"
:这里删除不需要的文件夹，例如：rd /s/q 文件名
start /wait VerstionBuild.exe 渠道22\ 渠道22\src\version\22\version.manifest 渠道22\src\version\22\project.manifest
copy ".\渠道22\src\version\22\*" ".\正式包\src\version\22\"
