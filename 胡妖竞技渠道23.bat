...
mkdir 正式包\res\achannel\23
xcopy res\achannel\23 正式包\res\achannel\23 /e
...
mkdir 渠道23
xcopy 正式包 渠道23 /e
mkdir 正式包\src\version\23
mkdir 渠道23\src\version\23
copy ".\src\version\23\*" ".\渠道23\src\version\23\"
:这里删除不需要的文件夹，例如：rd /s/q 文件名
start /wait VerstionBuild.exe 渠道23\ 渠道23\src\version\23\version.manifest 渠道23\src\version\23\project.manifest
copy ".\渠道23\src\version\23\*" ".\正式包\src\version\23\"
