...
--   大结算
---------------
local WSKGameRoomEnd = class("WSKGameRoomEnd", cc.load("mvc").ViewBase)
...
function WSKGameRoomEnd:onConfig()
	self.widget = {
		{'back', 'onBack'},
		{'Button_back','onBack'},
		{'zhanji', 'onHistory'},
...
function WSKGameRoomEnd:onEnter()
	require("common.Common"):screenshot(FileName.battlefieldScreenshot)
end

function WSKGameRoomEnd:onExit()
	
end

function WSKGameRoomEnd:onCreate(params)
...
function WSKGameRoomEnd:initPlayerInfo( ... )
...
function WSKGameRoomEnd:onBack(...)
	require("common.SceneMgr"):switchScene(require("app.MyApp"):create():createView("HallLayer"), SCENE_HALL)
end

function WSKGameRoomEnd:onHistory(...)
