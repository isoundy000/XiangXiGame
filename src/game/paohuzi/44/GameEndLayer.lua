...
function GameEndLayer:showMingTang(pBuffer)
    ...
    local PHZ_HT_HONGHU = 2              --红　胡   红字>10只，多一张红字+1番                                                                                                     (X 2倍)
    local PHZ_HT_ZHENGDIANHU = 4              --点胡    只有一张红字                                                                                                                                          (X 3倍)                                                                          (X 4倍)
    local PHZ_HT_HEIWU = 32              --黑乌    红字＝0，即全部是黑字                                                                                                                         (X 5倍)
    local PHZ_HT_DUIDUIHU = 64              --对对胡   全部对子                                                                                                                                                (X 4倍)
    local PHZ_HT_HAIDI = 512              --玩家所胡的牌是墩中最后的一只牌  平胡加1番，名堂胡加2番                                                                     (X 2倍)
    local PHZ_HT_TIANHU = 0x0400              --庄家或闲家所胡的牌为亮张牌 不加番，但息数×2；如果又是名堂胡，则先计算息数，再计算底数，     (X 4倍)
    local PHZ_HT_DIHU = 0x0800              --听胡(6) 起上来.玩家手中的牌有≥15息不进牌直接胡的（只要进牌不打牌出去的）                      (X 6倍)
